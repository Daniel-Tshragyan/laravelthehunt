                    ...
                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                        ...
                        @else
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('manage-applications')}}">Manage
                                                Applications</a></li>
                                        <li><a class="dropdown-item" href="{{route('browse-resumes')}}">Browse
                                                Resumes</a></li>
                                    </ul>
                                </li>
                            @elseif(auth()->user()->role == '1')
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{route('browse-jobs')}}">Browse Jobs</a>
                                        </li>
                                        <li><a class="dropdown-item" href="{{route('browse-categories')}}">Browse
                                                Categories</a></li>
                                        <li><a class="dropdown-item" href="{{route('add-resume')}}">Add Resume</a></li>
                                        <li><a class="dropdown-item" href="{{route('manage-resumes')}}">Manage
                                                Resumes</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{route('blog-left-sidebar')}}">Blog - Left
                                        Sidebar</a></li>
                                <li><a class="dropdown-item" href="{{route('blog-full-width')}}"> Blog full width</a>
                                </li>
                        ...
                        @guest
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('reg') }}">Register as Candidate</a>
                                    </li>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <form style="margin-top:10px" id="logout-form" action="{{ route('logout') }}"
                                      method="POST">
                                    @csrf
                    ...
                    <div class="widget">
                        ...
                        <div class="textwidget">
                            <p>Sed consequat sapien faus quam bibendum convallis quis in nulla. Pellentesque volutpat
                                odio eget diam cursus semper.</p>
                        </div>
                    </div>
                </div>
